...
$hash = hash('sha512',$key.'|'.$transaction['travally_transaction_details_id'].'|'.$transaction['travally_transaction_details_amount'].'|'.$transaction['travally_transaction_details_id'].'|'.$user['travally_profiles_name'].'|'.$user['email'].'|||||||||||'.$salt);
?>
    ...
    <input type="hidden" name="txnid" value="<?php echo $transaction['travally_transaction_details_id']; ?>" />
